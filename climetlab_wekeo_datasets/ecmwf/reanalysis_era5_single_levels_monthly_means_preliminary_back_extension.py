...
class reanalysis_era5_single_levels_monthly_means_preliminary_back_extension(Main):
    name = "EO:ECMWF:DAT:REANALYSIS_ERA5_SINGLE_LEVELS_MONTHLY_MEANS_PRELIMINARY_BACK_EXTENSION"
    dataset = "EO:ECMWF:DAT:REANALYSIS_ERA5_SINGLE_LEVELS_MONTHLY_MEANS_PRELIMINARY_BACK_EXTENSION"
