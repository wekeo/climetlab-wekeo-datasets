...
LAYERS = [
    "cmems_obs-sst_med_phy_my_l3s_P1D-m_202211",  # noqa: E501 Mediterranean sea sst, l3s, reprocessed using esa cci sst v.2.0, c3s v.2.0, c3s v.2.1 l3c product and pfv53 data, 0.05 deg. daily (sst med phy l3s my 010 042)
]
