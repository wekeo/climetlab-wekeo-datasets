...
LAYERS = [
    "cmems_obs-oc_blk_bgc-optics_my_l3-multi-1km_P1D_202207",  # noqa: E501 cmems_obs-oc_blk_bgc-optics_my_l3-multi-1km_P1D_202207
    "cmems_obs-oc_blk_bgc-optics_my_l3-multi-1km_P1D_202311",  # noqa: E501 cmems_obs-oc_blk_bgc-optics_my_l3-multi-1km_P1D
    "cmems_obs-oc_blk_bgc-plankton_my_l3-multi-1km_P1D_202207",  # noqa: E501 cmems_obs-oc_blk_bgc-plankton_my_l3-multi-1km_P1D_202207
    ...
    "cmems_obs-oc_blk_bgc-reflectance_my_l3-multi-1km_P1D_202207",  # noqa: E501 cmems_obs-oc_blk_bgc-reflectance_my_l3-multi-1km_P1D_202207
    ...
    "cmems_obs-oc_blk_bgc-transp_my_l3-multi-1km_P1D_202207",  # noqa: E501 cmems_obs-oc_blk_bgc-transp_my_l3-multi-1km_P1D_202207
...
class oceancolour_blk_bgc_l3_my(Main):
    ...
    def __init__(
        ...
        if layer == "cmems_obs-oc_blk_bgc-optics_my_l3-multi-1km_P1D_202311":
            if min_date is None:
                min_date = "1997-09-16T00:00:00Z"
        ...
        if layer == "cmems_obs-oc_blk_bgc-plankton_my_l3-multi-1km_P1D_202311":
            if min_date is None:
                min_date = "1997-09-16T00:00:00Z"
        ...
        if layer == "cmems_obs-oc_blk_bgc-reflectance_my_l3-multi-1km_P1D_202311":
            if min_date is None:
                min_date = "1997-09-16T00:00:00Z"
        ...
        if layer == "cmems_obs-oc_blk_bgc-transp_my_l3-multi-1km_P1D_202311":
            if min_date is None:
                min_date = "1997-09-16T00:00:00Z"
