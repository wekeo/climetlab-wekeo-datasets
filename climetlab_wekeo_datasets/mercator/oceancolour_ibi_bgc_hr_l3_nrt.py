...
LAYERS = [
    ...
    "cmems_obs_oc_ibi_bgc_tur-spm-chl_nrt_l3-hr-mosaic_P1D-m_202107",  # noqa: E501 Cmems hr-oc iberian sea transparency (spm, tur) and geophysical (chl) daily observations mosaic
]


class oceancolour_ibi_bgc_hr_l3_nrt(Main):
